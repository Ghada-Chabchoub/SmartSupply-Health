        ...
        <div className="orders-container">
            ...
            {orders.length === 0 ? (
                <div className="no-orders">
                    ...
                    <p>Aucune commande ne contient vos produits{filter !== 'all' ? ` avec le statut "${filter}"` : ''}.</p>
                </div>
            ) : (
                        ...
                        <tbody>
                            {orders.map((order) => (
                                <tr key={order._id}>
                                    ...
                                    <td>
                                        {order.client.name} ({order.client.clinicName})
                                    </td>
                        ...
                        <div className="modal-body">
                            <div className="order-info">
                                <div className="info-row">
                                    ...
                                    <span className="value">{selectedOrder.client.name} ({selectedOrder.client.clinicName})</span>
                                </div>
                                <div className="info-row">
